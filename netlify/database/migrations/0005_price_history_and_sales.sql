...
--
-- card_price_snapshots stores one market-value reading per card + finish per day,
-- so price movement (gainers / losers) can be computed over any time window.
-- card_sales is an append-only ledger of realized sales, giving accurate
-- time-stamped revenue, cost of goods sold, and realized ROI.
