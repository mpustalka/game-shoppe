...
export default function BindersPage() {
  ...
  useEffect(() => {
    ...
    setError(null)
    binderApi
      .loadBinder(activeTier, language)
      .then(setBinderItems)
  ...
  async function handleAddCard() {
    ...
    try {
      await binderApi.addToBinder(activeTier, card, language)
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_12%_6%,rgba(255,213,79,.34),transparent_28%),radial-gradient(circle_at_92%_2%,rgba(59,130,246,.18),transparent_24%),linear-gradient(180deg,#fffdf4_0%,#f4fbff_48%,#fff9ea_100%)]">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="en">English Binders</SelectItem>
            <SelectItem value="ja">Japanese Binders</SelectItem>
          </SelectContent>
        </Select>
          ...
          <CardContent>
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setFilterCondition(v as CardCondition | "all")
                }
              >
                  ...
                  <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-slate-950">
                        {activeTierInfo.label} Sell Binder
                      </h3>
                    </div>
                    ...
                    {filteredItems.map((item) => (
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="block h-full overflow-hidden rounded-lg bg-sky-50"
                        >
                          <img
            ...
            <CardContent className="flex items-center gap-4 py-4">
              ...
              <div>
                ...
                <p className="text-xl font-semibold">
                  $
                  {(
                    tierStats.budget.totalValue +
                    tierStats.mid.totalValue +
                    tierStats.premium.totalValue
                  ).toFixed(2)}
                </p>
              </div>
            </CardContent>
